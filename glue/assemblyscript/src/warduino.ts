...
//                           (_topic: ArrayBuffer, _topic_length: i32, _payload: ArrayBuffer, _payload_length: i32) => { callback(String.UTF8.decode(_topic, true), String.UTF8.decode(_payload, true)); } );
//}
//
